...
if(!isset($_GET['nomobile'])){
	$useragent=$_SERVER['xHTTP_USER_AGENT'];
		...
		<form>
			<div id="wrap">
				<div id="header">
					...
					<br/><br/>
					<a href="/"><img src="design/slogan.png" border="0"/></a>
				</div>
				<div id="contenthome">
					<br/>
					<div id="boxes">
						<a href="meats.php"><img src="design/home_meats.png" border="0" onmouseover="this.src='design/home_meats_callout.png'" onmouseout="this.src='design/home_meats.png'"/></a>
						<a href="spit.php"><img src="design/home_spit.png" border="0" onmouseover="this.src='design/home_spit_callout.png'" onmouseout="this.src='design/home_spit.png'"/></a>
						<a href="about.php"><img src="design/home_about.png" border="0" onmouseover="this.src='design/home_about_callout.png'" onmouseout="this.src='design/home_about.png'"/></a>
					</div>
				</div>
			</div>
			<div id="footer">
